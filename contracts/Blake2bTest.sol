...
contract Blake2bTest {
    function testOneBlock(bytes memory input, uint output_len) public returns (bytes memory) {
        return Blake2b.hash(output_len, input);
    }

    /* FIXME: maybe make these work again for fun
